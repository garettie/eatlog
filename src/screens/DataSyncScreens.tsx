...
export function HealthConnectScreen({ onDataChanged }: { onDataChanged: () => void }) {
  ...
  return (
    <Screen>
      <ScrollView contentContainerClassName="p-6 gap-6">
        <View className="gap-2"><Text className="text-lg font-bold text-m3-on-surface">Two-way weight sync</Text><Text className="text-sm text-m3-on-surface-variant">Marco reads the latest external weight per day from the last 30 days and publishes weights you enter in Marco.</Text></View>
        <Card className="p-5 gap-3">
