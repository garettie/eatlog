...
Every export derives from `assets/icon.png`, the canonical opaque 1024×1024 flat-white egg mask. The mask, red indicator, and scale marks are unchanged. Store variants change only canvas size, format, background, and padding.
