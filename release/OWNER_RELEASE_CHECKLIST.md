...
- [ ] **PHYSICAL DEVICE:** inspect saved Meal Photo, Framed, Nutrition, Day, and Logging consistency PNGs for exact 1080 by 1920 dimensions, upright orientation, intended crop, legible Onest text, and absence of source GPS, camera model, original filename, and capture timestamp metadata.
