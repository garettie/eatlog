...
| Omelette price | Owner set PHP 349 on 2026-09-25; the website shows `₱349 once` | Set PHP 349 on the `eatlog_itik` `buy` purchase option in Play Console and on the Test Store product in RevenueCat, then confirm it in a purchase sheet; the app shows the store's localized price and hardcodes none |
